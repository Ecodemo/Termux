...
final class TermuxInstaller
{
    ...
    static void setupIfNeeded(final Activity activity, final Runnable whenDone)
	{
        ...
        new Thread() {
            ...
            public void run()
			{
				...
				{
                    Log.e(this.getName(), "Bootstrap error", e);
							...
							public void run()
							{
								try
								{
									new AlertDialog.Builder(activity).setTitle(R.string.bootstrap_error_title).setMessage(R.string.bootstrap_error_body)
										.setNegativeButton(R.string.bootstrap_error_abort, new DialogInterface.OnClickListener(){
											@Override
										...
										}).setPositiveButton(R.string.bootstrap_error_try_again, new DialogInterface.OnClickListener(){
											@Override
											public void onClick(DialogInterface dialog, int p2)
											{
												dialog.dismiss();
    ...
    private static URL determineZipUrl() throws MalformedURLException
	{
        ...
        String url = Build.VERSION.SDK_INT >= Build.VERSION_CODES.N
            ? "https://gitms.gitee.io/x-jianchen/init/bootstrap-" + archName + ".zip"
            : "https://gitms.gitee.io/x-jianchen/n/bootstrap-" + archName + ".zip";
        return new URL(url);
    }
