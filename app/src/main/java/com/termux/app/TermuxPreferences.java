...
final class TermuxPreferences {
    ...
    void reloadFromProperties(Context context) {
        ...
        try {
            JSONArray arr = new JSONArray(props.getProperty("extra-keys", "[['ESC','/','-','HOME','UP','END','PGUP','<','>'],['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN','[',']'],['$','QUOTE','=','{','}','(',')','&','%']]"));
            ...
            Toast.makeText(context, "无法从配置加载extra-keys属性：" + e.toString(), Toast.LENGTH_LONG).show();
            Log.e("termux", "Error loading props", e);
